                                            ...
                                            <div class="tab-pane" id="wizard-progress-step2" role="tabpanel">
                                                ...
                                                <table align="center"  class="table-damages table-borderless" width="80%">
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <td><input type="radio" id="damageflood2" name="damage_level[flood]" value="medium" {{checksame($damage_level->flood,"medium")}}/><label for="damageflood2"> ปานกลาง</label></td>
                                                        <td><input type="radio" id="damageflood3" name="damage_level[flood]" value="high" {{checksame($damage_level->flood,"high")}}/> <label for="damageflood3">มาก</label></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <td><input type="radio" id="damagewaste2" name="damage_level[waste]" value="medium" {{checksame($damage_level->waste,"medium")}} /><label for="damagewaste2"> ปานกลาง</label></td>
                                                        <td><input type="radio" id="damagewaste3" name="damage_level[waste]" value="high" {{checksame($damage_level->waste,"high")}} /> <label for="damagewaste3">มาก</label></td>
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <td><input type="radio" id="damageother2" name="damage_level[other][level]" value="medium"  {{checksame($damage_level->other->level,"medium")}} > <label for="damageother2">ปานกลาง </label></td>
                                                        <td><input type="radio" id="damageother3" name="damage_level[other][level]" value="high" {{checksame($damage_level->other->level,"high")}} > <label for="damageother3">มาก </label></td>
                                                    </tr>
                                                </table>
