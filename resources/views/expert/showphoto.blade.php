                      ...
                      <div class="card-header">
                        ...
                        <div class="card-body" >
                          ...
                          <div class="row">
                              ...
                              <div class="column">
                                  <img src="{{asset($data[0]->blk_code)}}.JPG" onclick="openModal();currentSlide({{2}})" style="width: 80%" class="hover-shadow cursor">
                              </div>
                          </div>
                          <br>
                          ...
                          <div class="row">
                            ...
                            <?php for($i=0;$i<count($photo_Blockage);$i++){?>
                              <div class="column">
                                  <img src="{{asset($photo_Blockage[$i]->photo_name)  }}" onclick="openModal();currentSlide({{$i+3}})" style="width:100%" class="hover-shadow cursor">
                              </div>
                          <?php } ?> 
                          </div>
                          ...
                          <div id="myModal" class="modal">
                              ...
                              <div class="modal-content">
                                <?php   $num =count($photo_Blockage)+2; ?>
                                  <div class="mySlides">
                                    <div class="numbertext">{{$i+1}} / {{$num}}</div>
                                      <center><img src="{{asset($expert[0]->exp_pixmap)  }}"  style="width:50%"></center>
                                    </div>
                                  </div>
                                  <div class="mySlides">
                                    <div class="numbertext">{{$i+2}} / {{$num}}</div>
                                      <center><img src="/images/map/{{($data[0]->blk_code)}}.JPG"  style="width:80%"></center>
                                    </div>
                                  
                                  <?php for($i=0;$i<count($photo_Blockage);$i++){?>
                                        <div class="mySlides">
                                            <div class="numbertext">{{$i+3}} / {{$num}}</div>
                                            <img src="{{asset($photo_Blockage[$i]->photo_name)  }}"  style="width:80%">
                                        </div>
                                  <?php } ?>
                                ...
                                <div class="caption-container" width=120%>
                                  ...
                                  <div class="columnDown">
                                    <img class="demo cursor" src="/images/map/{{($data[0]->blk_code)}}.JPG" style="width:40%" onclick="currentSlide({{1}})" >
                                  </div>
                                  <?php for($i=0;$i<count($photo_Blockage);$i++){?>
                                      <div class="columnDown">
                                          <img class="demo cursor" src="{{asset($photo_Blockage[$i]->photo_name)  }}" style="width:100%" onclick="currentSlide({{$i+2}})" >
                                      </div>
                                  <?php } ?>
